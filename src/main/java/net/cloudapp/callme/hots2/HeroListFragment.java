...
import net.cloudapp.callme.hots2.adapters.MyAdapter;
        ...
        switch (item.getItemId()) {
            ...
            case R.id.action_sort:
                new MaterialDialog.Builder(getActivity())
                        ...
                        .items(new CharSequence[]{"All", "Free", "Assassin", "Specialist", "Support", "Warrior"})
                        ...
                        .backgroundColor(R.color.sorta_dark_purple)
//                        .positiveText("SELECT")
//                        .negativeText("CANCEL")
                        .show();
                break;
    ...
    private class CheckForUpdate extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... voids) {
            ...
            int localHeroCount = heroDatabase.getAllHeroes().size();
            String json = null;
            try {
            ...
            if (json != null) {
                ...
                int serverHeroCount = serverHeroes.size();

                if (serverHeroCount > localHeroCount) {
