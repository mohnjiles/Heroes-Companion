...
import net.cloudapp.callme.hots3.TalentFragment;
    ...
    public static class ViewHolder extends ObservableRecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View view) {
            if (talent != null) {
                ...
                String heroName = HeroDatabase.getInstance(context)
                        .getHeroById(talent.getHeroId()).getName();

                // hide help text and show the icons section
                ...
                switch (talentTier) {
                    case 1:
                        ...
                        fragment.setIvLvl1Name(talent.getName());
                        //ivLvl1.setImageResource(imageResourceId);
                        fragment.setmLvl1Talent(talent);
                        Utils.GlideLoadSpellImage(context, talent.getName(), heroName, ivLvl1);
                        break;
                    case 4:
                        ...
                        fragment.setIvLvl4Name(talent.getName());
                        Utils.GlideLoadSpellImage(context, talent.getName(), heroName, ivLvl4);
                        fragment.setmLvl4Talent(talent);
                    ...
                    case 7:
                        ...
                        fragment.setIvLvl7Name(talent.getName());
                        Utils.GlideLoadSpellImage(context, talent.getName(), heroName, ivLvl7);
                        fragment.setmLvl7Talent(talent);
                    ...
                    case 10:
                        ...
                        fragment.setIvLvl10Name(talent.getName());
                        Utils.GlideLoadSpellImage(context, talent.getName(), heroName, ivLvl10);
                        fragment.setmLvl10Talent(talent);
                        break;
                    case 13:
                        ...
                        fragment.setIvLvl13Name(talent.getName());
                        Utils.GlideLoadSpellImage(context, talent.getName(), heroName, ivLvl13);
                        fragment.setmLvl13Talent(talent);
                        break;
                    case 16:
                        ...
                        fragment.setIvLvl16Name(talent.getName());
                        Utils.GlideLoadSpellImage(context, talent.getName(), heroName, ivLvl16);
                        fragment.setmLvl16Talent(talent);
                        break;
                    case 20:
                        ...
                        fragment.setIvLvl20Name(talent.getName());
                        Utils.GlideLoadSpellImage(context, talent.getName(), heroName, ivLvl20);
                        fragment.setmLvl20Talent(talent);
