    ...
    public Filter getFilter() {
        return new Filter() {
            ...
            protected FilterResults performFiltering(CharSequence charSequence) {
                ...
                if (charSequence != null && freeHeroes != null
                ...
                } else if (charSequence == "New") {
                    List<Hero> orderedList = new ArrayList<>(originalList);
                    Collections.sort(orderedList, new Comparator<Hero>() {
                        @Override
                        public int compare(Hero hero, Hero t1) {
                            if (hero.getId() < t1.getId())
                                return -1;
                            else
                                return 1;
                        }
                    ...
                    results.add(orderedList.get(0));
                    results.add(orderedList.get(1));
                    results.add(orderedList.get(2));
