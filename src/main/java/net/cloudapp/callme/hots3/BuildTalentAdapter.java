    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        if (holder instanceof ItemViewHolder) {
            ...
            int talentResId = Utils.getResourceIdByName(
                    context, talent.getName());
            String talentUrl = Constants.IMAGE_BASE_URL + heroName + "/"
                    + Utils.formatSpellImageName(talent.getName()) + ".png";
            Utils.GlideLoadImage(context, talentResId, talentUrl,
                    ((ItemViewHolder)holder).ivTalentImage);
            ...
            int smallHeroResId = Utils.getResourceIdByName(context, heroName);
            String smallHeroUrl = Constants.HERO_IMAGES_URL
                    + Utils.formatSpellImageName(heroName) + ".png";
            Utils.GlideLoadImage(context, smallHeroResId, smallHeroUrl,
                    ((HeaderViewHolder) holder).ivHeroImage);

            int bigHeroResId = Utils.getResourceIdByName(context, heroName + "big");
            String bigHeroUrl = Constants.BIG_HERO_IMAGES_URL
                    + Utils.formatSpellImageName(heroName) + "big.compressed.png";
            Utils.GlideLoadImage(context, bigHeroResId, bigHeroUrl,
                    ((HeaderViewHolder) holder).ivBigHeroImage);
        }
    }
